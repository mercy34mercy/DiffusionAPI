...
def gqlclient(imageurl,word,userid,englishword):
    ...
    query = gql('mutation createDiary{createDiary(input:{Userid:"%s",Imageurl:"%s",Word:"%s",Englishword:"%s"}){Diaryid}}' % (userid,imageurl,word,englishword) )
